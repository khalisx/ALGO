...
void lireFichier(const char *nomFichier, Voiture **voitures, int *nbVoitures, int *tailleTableau);
void RemplirTableau(const char *nomFichier, Voiture voitures[], int *nbVoitures);
